...
\newcommand{\algebraVector}[1]{\mathbf{#1}}
...
\emph{\textbf{Find the best possible approximation $\algebraVector{x} = (x_1, \dots, x_m)$ of the ideal mixture,
$\algebraVector{c} = (c_1, \dots, c_n)$, by using the material from the $m$ mines.}}
